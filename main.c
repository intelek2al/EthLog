...
// int flag_parser(struct message message) {
//     switch (message.flag) {
//     case FLAG_START:
...
//                     strcpy(test_data, "new data!!");
//                     // connect_to_client(client_message.fd, SOCKET_NAME);
//                     // send_message(1, client_message.buf);
//                 }
//                 sleep(1);
//             }
...
//             // int ret_res = recvmsg(socket_fd, &resp, MSG_WAITALL);
//             sleep(1);
//             printf("Data is %s\n", test_data);
//             // // if (ret_res <)
...
//     /* Open the log file */
//     openlog ("ethlog", LOG_PID, LOG_DAEMON);
// }
